quat2angle MATLAB Python Package
...
2. Installing the quat2angle Package

A. Change to the directory that contains the file setup.py and the subdirectory 
quat2angle. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the quat2angle Package
...
The quat2angle package is on your Python path. To import it into a Python script or 
session, execute:
